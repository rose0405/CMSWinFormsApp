...
namespace CMSWinFormsApp {
    ...
    public partial class CMSDBDataSet : global::System.Data.DataSet {
        ...
        public partial class tblJobDetailsDataTable : global::System.Data.TypedTableBase<tblJobDetailsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tblJobDetailsRow FindByWorkerID(int WorkerID) {
    ...
    public partial class tblJobDetailsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblJobDetails] WHERE (([CarNo] = @Original_CarNo) AND ([JobDat" +
                ...
                "= 1 AND [KMs] IS NULL) OR ([KMs] = @Original_KMs)) AND ((@IsNull_Tuning = 1 AND " +
                "[Tuning] IS NULL) OR ([Tuning] = @Original_Tuning)) AND ((@IsNull_Alignment = 1 " +
...
SELECT CarNo, JobDate, WorkerID, KMs, Tuning, Alignment, Balancing, Tires, Weights, OilChanged, OilQty, OilFilter, GearOil, GearOilQty, Point, Condenser, Plug, PlugQty, FuelFilter, AirFilter, Remarks FROM tblJobDetails WHERE (WorkerID = @WorkerID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CarNo", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CarNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblJobDetails] SET [CarNo] = @CarNo, [JobDate] = @JobDate, [WorkerI" +
                "D] = @WorkerID, [KMs] = @KMs, [Tuning] = @Tuning, [Alignment] = @Alignment, [Bal" +
                "ancing] = @Balancing, [Tires] = @Tires, [Weights] = @Weights, [OilChanged] = @Oi" +
                "lChanged, [OilQty] = @OilQty, [OilFilter] = @OilFilter, [GearOil] = @GearOil, [G" +
                "earOilQty] = @GearOilQty, [Point] = @Point, [Condenser] = @Condenser, [Plug] = @" +
                "Plug, [PlugQty] = @PlugQty, [FuelFilter] = @FuelFilter, [AirFilter] = @AirFilter" +
                ", [Remarks] = @Remarks WHERE (([CarNo] = @Original_CarNo) AND ([JobDate] = @Orig" +
                "inal_JobDate) AND ([WorkerID] = @Original_WorkerID) AND ((@IsNull_KMs = 1 AND [K" +
                "Ms] IS NULL) OR ([KMs] = @Original_KMs)) AND ((@IsNull_Tuning = 1 AND [Tuning] I" +
                "S NULL) OR ([Tuning] = @Original_Tuning)) AND ((@IsNull_Alignment = 1 AND [Align" +
                "ment] IS NULL) OR ([Alignment] = @Original_Alignment)) AND ((@IsNull_Balancing =" +
                " 1 AND [Balancing] IS NULL) OR ([Balancing] = @Original_Balancing)) AND ((@IsNul" +
                "l_Tires = 1 AND [Tires] IS NULL) OR ([Tires] = @Original_Tires)) AND ((@IsNull_W" +
                "eights = 1 AND [Weights] IS NULL) OR ([Weights] = @Original_Weights)) AND ((@IsN" +
                "ull_OilChanged = 1 AND [OilChanged] IS NULL) OR ([OilChanged] = @Original_OilCha" +
                "nged)) AND ((@IsNull_OilQty = 1 AND [OilQty] IS NULL) OR ([OilQty] = @Original_O" +
                "ilQty)) AND ((@IsNull_OilFilter = 1 AND [OilFilter] IS NULL) OR ([OilFilter] = @" +
                "Original_OilFilter)) AND ((@IsNull_GearOil = 1 AND [GearOil] IS NULL) OR ([GearO" +
                "il] = @Original_GearOil)) AND ((@IsNull_GearOilQty = 1 AND [GearOilQty] IS NULL)" +
                " OR ([GearOilQty] = @Original_GearOilQty)) AND ((@IsNull_Point = 1 AND [Point] I" +
                "S NULL) OR ([Point] = @Original_Point)) AND ((@IsNull_Condenser = 1 AND [Condens" +
                "er] IS NULL) OR ([Condenser] = @Original_Condenser)) AND ((@IsNull_Plug = 1 AND " +
                "[Plug] IS NULL) OR ([Plug] = @Original_Plug)) AND ((@IsNull_PlugQty = 1 AND [Plu" +
                "gQty] IS NULL) OR ([PlugQty] = @Original_PlugQty)) AND ((@IsNull_FuelFilter = 1 " +
                "AND [FuelFilter] IS NULL) OR ([FuelFilter] = @Original_FuelFilter)) AND ((@IsNul" +
                "l_AirFilter = 1 AND [AirFilter] IS NULL) OR ([AirFilter] = @Original_AirFilter))" +
                " AND ((@IsNull_Remarks = 1 AND [Remarks] IS NULL) OR ([Remarks] = @Original_Rema" +
                "rks)));\r\nSELECT CarNo, JobDate, WorkerID, KMs, Tuning, Alignment, Balancing, Tir" +
                "es, Weights, OilChanged, OilQty, OilFilter, GearOil, GearOilQty, Point, Condense" +
                "r, Plug, PlugQty, FuelFilter, AirFilter, Remarks FROM tblJobDetails WHERE (Worke" +
                "rID = @WorkerID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CarNo", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CarNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
